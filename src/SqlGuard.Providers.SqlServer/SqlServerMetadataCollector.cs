...
{
    internal sealed class SqlServerMetadataCollector : IMetadataCollector, IAsyncDisposable
    {
        private readonly SqlConnection _conn;
        private string? _serverVersion;

        public SqlServerMetadataCollector(SqlConnection conn) => _conn = conn;
        ...
        public string ServerVersion
        {
            get
            {
                ...
                // conn.ServerVersion is "MM.mm.build" e.g. "16.00.4175"
        ...
        {
            await using var cmd = new SqlCommand(sql, _conn) { CommandTimeout = 30 };
